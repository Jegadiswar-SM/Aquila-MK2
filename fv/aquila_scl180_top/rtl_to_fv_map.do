...
# Generated on: Fri Sep 04 16:35:09 IST 2026 (Fri Sep 04 11:05:09 UTC 2026)
...
set logfile fv/aquila_scl180_top/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/aquila_scl180_top -revised fv_map
...
add_search_path /home/24bvd1009/bolter/Aquila-MK2/rtl /home/24bvd1009/bolter/Aquila-MK2/rtl/asic -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 -f  /home/24bvd1009/bolter/Aquila-MK2/cadence/genus/qualify_asic_filelist.f
elaborate_design -golden -root {aquila_scl180_top} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/aquila_scl180_top/fv_map.v.gz
elaborate_design -revised -root {aquila_scl180_top}
...
#add_name_alias fv/aquila_scl180_top/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.aquila_scl180_top.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.aquila_scl180_top.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.aquila_scl180_top.rtl.fv_map.rpt
